...
if __name__ == '__main__':
    ...
    workers = [Worker(game=GymNav(number_of_agents=number_of_agents), 
                            name=i, 
                            s_size=state_size, 
                            s_size_central=s_size_central,
                            a_size=action_size, 
    ...
    # Start the "work" process for each worker in a separate process.
    # [w.start() for w in workers]
    # [w.join() for w in workers]

    # This uses threads instead of processes.
    worker_threads = []
